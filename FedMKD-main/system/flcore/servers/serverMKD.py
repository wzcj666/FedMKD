...
from flcore.clients.clientMKD import clientMKD
...
class MKD(Server):
    ...
    def aggregate_parameters(self):
        ...
        model = load_item(self.role, 'global_model', self.save_folder_name)
        for client in self.selected_clients:
            save_item(model, client.role, 'global_model', self.save_folder_name)
