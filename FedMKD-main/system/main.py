...
from flcore.servers.serverMKD import MKD
...
def run(args):
    ...
    for i in range(args.prev, args.times):
        ...
        if args.model_family == "HtFE2":
            args.models = [
                'FedAvgCNN(in_features=3, num_classes=args.num_classes, dim=1600)',     # 通道3 RGB  种类   维度
                'torchvision.models.resnet18(pretrained=False, num_classes=args.num_classes)',    # 未预训练
            ]
            ...
            args.models = [
                ...
                'torchvision.models.googlenet(pretrained=False, aux_logits=False, num_classes=args.num_classes)',    # 未预训练  辅助分类器不用   种类类别
            ...
            args.models = [
                ...
                # 'FedAvgCNN(in_features=3, num_classes=args.num_classes, dim=1024)',
            ...
            args.models = [
                'CNN(num_cov=1, hidden_dims=[], in_features=3, num_classes=args.num_classes)',
                'CNN(num_cov=2, hidden_dims=[], in_features=3, num_classes=args.num_classes)',
                'CNN(num_cov=1, hidden_dims=[512], in_features=3, num_classes=args.num_classes)',
                'CNN(num_cov=2, hidden_dims=[512], in_features=3, num_classes=args.num_classes)',
                'CNN(num_cov=1, hidden_dims=[1024], in_features=3, num_classes=args.num_classes)',
                'CNN(num_cov=2, hidden_dims=[1024], in_features=3, num_classes=args.num_classes)',
                'CNN(num_cov=1, hidden_dims=[1024, 512], in_features=3, num_classes=args.num_classes)',
                'CNN(num_cov=2, hidden_dims=[1024, 512], in_features=3, num_classes=args.num_classes)',
            ]
